...
public class calculator
{
  ...
  private JFrame f_;
  private String label_font = "Open Sans", button_font = "Open Sans";
  private int label_size = 32, button_size = 18;
  ...
  calculator()
  {
    ...
    int[] dmns = {0, 0, (f_.getWidth() - 30), 100};
    JLabel frame = new JLabel("null", SwingConstants.RIGHT);
    frame.setFont(new Font(this.label_font, Font.PLAIN, this.label_size));
    frame.setBounds(dmns[0], dmns[1], dmns[2], dmns[3]);
